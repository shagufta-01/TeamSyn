        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              <img 
                src={teamsynclogo}
                alt="Company logo"
                className="w-10 h-10 mr-3 rounded backdrop-brightness-500"
              />
              <h3 className="text-xl font-bold">Teamsync</h3>
            </div>
            <p className="text-gray-300 mb-4">
              Providing innovative solutions since 2025. We're committed to excellent customer service.
            </p>
            <div className="flex space-x-4 mt-6">
              ...
              <a href="#" className="text-black-300 hover:text-white transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition">Community Forums</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">System Status</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">Developer API</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">Contact Support</a></li>
            </ul>
          </div>
